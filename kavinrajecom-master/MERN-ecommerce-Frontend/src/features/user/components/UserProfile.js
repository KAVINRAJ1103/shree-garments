...
export default function UserProfile() {
  ...
  return (
    <div>
      <div className="shadow-lg mx-auto mt-4 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
        <br></br><div className="">
          <h1 className="text-4xl my-5 font-bold tracking-tight text-black-900">
            Name: {userInfo.name ? userInfo.name : 'User Name'}
          </h1>
          <h3 className="text-xl my-5 font-bold tracking-tight text-black-900">
        ...
        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
          ...
          <b><p className="p-3 mb-5 bg-body-tertiary rounded">Your Addresses :</p></b>
                  ...
                  <div className="space-y-12">
                    ...
                    <div className="mt-6 flex items-center justify-end gap-x-6">
                      <button
                        ...
                        type="submit"
                        className="rounded-md px-3 py-2 text-sm font-semibold text-grey shadow-lg hover:bg-grey-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                      >
                        Cancel
                      </button>
                      <button
